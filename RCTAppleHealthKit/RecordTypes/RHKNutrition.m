...
- (void)saveFood:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback
{
    ...
    double energyConsumedValue = [RCTAppleHealthKit doubleFromOptions:input key:@"dietaryEnergy" withDefault:(double)0];
    ...
    double fatMonounsaturatedValue = [RCTAppleHealthKit doubleFromOptions:input key:@"monounsaturatedFat" withDefault:(double)0];
    ...
    double fatPolyunsaturatedValue = [RCTAppleHealthKit doubleFromOptions:input key:@"polyunsaturatedFat" withDefault:(double)0];
    ...
    double fatSaturatedValue = [RCTAppleHealthKit doubleFromOptions:input key:@"saturatedFat" withDefault:(double)0];
    ...
    double fatTotalValue = [RCTAppleHealthKit doubleFromOptions:input key:@"totalFat" withDefault:(double)0];
