...
- (HKQuantityTypeIdentifier)getQuantityTypeIdentifier:(NSString *)type
{
    ...
    dispatch_once(&once, ^{
        typeMapping = @{
            ...
            @"energy": HKQuantityTypeIdentifierDietaryEnergyConsumed,
            @"fatMonounsaturated": HKQuantityTypeIdentifierDietaryFatMonounsaturated,
            @"fatPolyunsaturated": HKQuantityTypeIdentifierDietaryFatPolyunsaturated,
            @"fatSaturated": HKQuantityTypeIdentifierDietaryFatSaturated,
            ...
            @"pantothenicAcid": HKQuantityTypeIdentifierDietaryPantothenicAcid,
            ...
            @"vitaminA": HKQuantityTypeIdentifierDietaryVitaminA,
            @"vitaminB12": HKQuantityTypeIdentifierDietaryVitaminB12,
            @"vitaminB6": HKQuantityTypeIdentifierDietaryVitaminB6,
            @"vitaminC": HKQuantityTypeIdentifierDietaryVitaminC,
            @"vitaminD": HKQuantityTypeIdentifierDietaryVitaminD,
            @"vitaminE": HKQuantityTypeIdentifierDietaryVitaminE,
            @"vitaminK": HKQuantityTypeIdentifierDietaryVitaminK,
...
- (NSString *)getUnitString:(NSString *)type
{
    ...
    dispatch_once(&once, ^{
        unitMapping = @{
            ...
            @"copper": @"mg",
            @"energy": @"kcal",
            @"fatMonounsaturated": @"g",
            @"fatPolyunsaturated": @"g",
            @"fatSaturated": @"g",
            @"fatTotal": @"g",
            @"fiber": @"g",
            @"folate": @"mcg",
